...
public class Main extends WindowController implements KeyListener
{
  ...
  private Lily pad;
   ...
   public void begin()
   {
     ...
     mcQueen = new Vehicle(getImage("van_right.gif"), canvas, 20,90, .0135,0,gerald);
     tax =  new Vehicle(getImage("taxi_right.gif"), canvas, 20,240, .0195,0,gerald);
     jee = new Vehicle(getImage("jeep_left.gif"), canvas, 550, 170, -.0235,0,gerald);
     old =  new Vehicle(getImage("oldcar_left.gif"), canvas, 550,320, -.0115,0,gerald);
